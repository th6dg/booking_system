...
public interface IRoomRepository extends JpaRepository<Room, Long> {
    ...
    @Query(value = "SELECT r.roomId, r.roomType, r.roomStatus, r.price, h.hotelId " +
                    ...
                    "INNER JOIN hotel h ON rh.hotelId = h.hotelId "+
    ...
    @Query(value = "SELECT r.roomId AS roomId, r.roomType AS roomType, r.roomStatus AS roomStatus, r.price AS price, h.hotelId AS hotelId, h.hotelName AS hotelName,"+
                    "l.locationId AS locationId, l.country AS country, l.province AS province, l.city AS city "+
                    "FROM room r "+
    ...
    List<RoomFilterDTO> getAllRoomAndHotelLocation();
}
